...
class DictProcess(object):
    def __init__(self, data, stocknum):
        ...
        dict_kairi = Dict(data.ma_kairi)   #SKairi Dict
...
class Dict(DictTop):
    ...
    def kairidict(self, ax):
        ...
        dat['U0'].plot(ax=ax, figsize=(setting.FST, setting.FSY), legend=False, linestyle='--', marker='', color='green')      
        dat['U1'].plot(ax=ax, figsize=(setting.FST, setting.FSY), legend=False, linestyle='--', marker='', color='green')     
        dat['D0'].plot(ax=ax, figsize=(setting.FST, setting.FSY), legend=False, linestyle='--', marker='', color='green')     
        dat['D1'].plot(ax=ax, figsize=(setting.FST, setting.FSY), legend=False, linestyle='--', marker='', color='green')  
